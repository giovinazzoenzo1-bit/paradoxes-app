...
export const EFFETS = {
  ...
  // ⚠️ 26/09 (test de l'auteur, Caraploof) : sans minimum, un bouclier lancé
  // PV pleins valait 0 — mana perdue et AUCUNE icône : « le bouclier ne
  // marche pas ». Minimum : 20 % des PV max.
  bouclierMinimum: 0.20,
...
export const AVENTURE_MULTIPLICATEURS = [
  0.39, 0.61, 0.62, 0.69, 1.16, 1.16, 0.83, 1.09, 0.74, 0.79, 2.28, 2.71, 2.55, 2.26, 2.31, 2.49, 2.31, 2.39, 1.99, 1.65, 1.79, 1.98, 1.75, 1.51, 2.05, 1.93, 2.28, 2.06, 2.29, 2.43, 2.48, 2.46, 3.06, 2.83, 2.93, 2.92, 2.92, 3.38, 3.87, 3.6, 3.72, 3.93, 3.69, 4.07, 4.11, 4.13, 4.5, 5.35, 4.87, 5.03, 5.05, 4.16, 5.19, 4.46, 5.81, 5.47, 5.78, 5.55, 6.69, 5.95, 5.79, 5.14, 5.88, 6.52, 7.21, 6.65, 6.79, 6.99, 6.17, 7.61, 8.12, 6.79, 7.63, 9.28, 8.73, 7.92, 8.22, 6.19, 7.75, 6.84, 8.65, 8.51, 8.31, 8.18, 10.06, 8.78, 7.74, 7.71, 9.06, 11.27, 12.81, 11.54, 11.27, 13.77, 8.81, 11.77, 13.11, 11.64, 12.38, 14.27, 13.3, 12.07, 15.17, 10.01, 13, 12.29, 12.49, 12.45, 13.99, 13.89, 16.66, 13.67, 14.88, 15.04, 16.45, 18, 20.42, 16.81, 19.67, 22.39, 15.5, 21.29, 20.83, 18.1, 20.02, 24.72, 22.07, 19.07, 23.46, 17.84, 17.94, 18.97, 19.92, 20.98, 22.63, 22.43, 25.26, 22.75, 16.13, 17.68, 19.99, 22.88, 25.35, 23.17, 20.83, 25.22, 16.25, 24.24, 26.62, 26.81, 28.91, 33.46, 32.04, 28.66, 35.12, 26.62, 27.1, 27.94, 28.76, 30.57, 28.4, 28.6, 34.13, 27.05, 31.07, 28.86, 25.63, 30.14, 32.27, 29.07, 25.95, 31.64, 19.81, 32.16, 30.96, 28.25, 31.3, 35.89, 31.75, 29.18, 38.02, 27.54, 27.69, 28.5, 30.36, 32.39, 29.44, 29.55, 37.21, 27.99, 32.74, 29.98, 26.28, 31.07, 32.86, 29.44, 26.86, 32.1, 20.17, 33.28, 32.1, 28.71, 30.3, 37.82, 34, 30.25, 37.48, 28.25, 29.81, 29.12, 29.98, 33.22, 29.98, 29.92, 37.21, 28.66, 33.16, 30.19, 26.52, 31.81, 33.7, 30.25, 27.15, 33.16, 20.42, 34, 32.56,
];
...
export const PUISSANCE_CONSEILLEE = [
  17, 22, 23, 27, 28, 35, 37, 40, 42, 48, 52, 54, 55, 58, 59, 60, 60, 60, 60, 60, 65, 66, 71, 71, 77, 96, 100, 105, 105, 107, 114, 121, 136, 148, 153, 162, 174, 182, 192, 201, 210, 222, 236, 247, 256, 272, 280, 289, 305, 315, 324, 334, 353, 353, 377, 377, 377, 384, 395, 402, 402, 402, 416, 417, 438, 440, 440, 462, 473, 509, 518, 518, 518, 535, 547, 552, 563, 577, 581, 587, 597, 601, 603, 606, 609, 617, 617, 659, 728, 807, 821, 821, 844, 854, 864, 873, 873, 886, 899, 907, 913, 913, 949, 952, 955, 960, 965, 965, 998, 1050, 1136, 1136, 1270, 1354, 1362, 1377, 1393, 1393, 1557, 1648, 1751, 1821, 1821, 1821, 1821, 1821, 1862, 1869, 1869, 1869, 1869, 1869, 1887, 1899, 1910, 1915, 1934, 1945, 1945, 1945, 1945, 2088, 2107, 2145, 2145, 2145, 2233, 2325, 2451, 2680, 2703, 2719, 2737, 2766, 2778, 2819, 2856, 2868, 2885, 2905, 2919, 2934, 2946, 2961, 2983, 2995, 3006, 3019, 3033, 3046, 3056, 3069, 3076, 3091, 3105, 3125, 3159, 3189, 3199, 3211, 3221, 3233, 3242, 3255, 3263, 3276, 3286, 3296, 3306, 3319, 3330, 3338, 3349, 3362, 3370, 3379, 3397, 3409, 3418, 3430, 3458, 3466, 3493, 3507, 3517, 3527, 3536, 3546, 3555, 3563, 3575, 3583, 3594, 3603, 3615, 3624, 3630, 3640, 3652, 3661, 3670, 3676, 3691, 3700, 3710, 3724, 3757,
];
...
// ---- Les QUÊTES suivent le niveau d'Aventure (26/09, décision de l'auteur) ----
// MESURÉ (test réel de l'auteur) : 603 Griffes de quêtes et succès en
// quelques minutes au début, 4 fois les combats — et, en fin de partie, trop
// peu pour monter les créatures qui naissent au niveau 1 (≈ 40 niveaux de
// retard). La récompense d'une quête du jour ou de la semaine est donc
// multipliée comme la prime de 1re victoire : ×1 au niveau 25 (la valeur
// écrite), ≈ ×0,24 au niveau 5, ≈ ×17 au niveau 100. Succès et calendrier
// inchangés.
export const NIVEAU_REFERENCE_QUETES = 25;
export function facteurQuetes(niveauAventure) {
  return griffesReward(Math.max(1, Math.floor(niveauAventure || 1))) / griffesReward(NIVEAU_REFERENCE_QUETES);
}
export function recompenseQuete(base, niveauAventure) {
  return Math.max(1, Math.round((base || 0) * facteurQuetes(niveauAventure)));
}
