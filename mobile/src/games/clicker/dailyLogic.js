...
// ---- Diamants sur les défis (14/09) ----
//
// Dosés par rapport au plafond des boss (21 💎/jour), qui reste la
// source RÉGULIÈRE de référence pour caler la boutique :
//   - quotidiens : seuls les 3 plus exigeants, +1 💎 — au plus ~1/jour
//     puisqu'on n'en tire que quelques-uns par jour ;
//   - hebdomadaires : +3 💎 chacun, soit 18/semaine (~2,6/jour) ;
//   - succès : 2/5/10/20/40 💎 selon le palier, UNE SEULE FOIS.
//
// Total régulier ≈ 3,6 💎/jour face aux 21 des boss : un vrai
// complément, sans renverser l'économie.
  { id: 'win2battles', desc: 'Gagne 2 combats en Aventure', event: 'battleWon', target: 2, reward: 40, diamonds: 1 },
...
export function achievementDiamonds(tierIndex) {
  return ACHIEVEMENT_TIER_DIAMONDS[tierIndex] || 0;
}
