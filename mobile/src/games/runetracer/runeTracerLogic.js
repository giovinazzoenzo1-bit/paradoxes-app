...
const SAMPLE_N = 120;
const TOLERANCE = 0.02; // légèrement réassoupli (0.015→0.02) après retour "un peu sévère" sur
// des tracés honnêtes de formes à segments droits (coche) — le gribouillage reste bien
// pénalisé à cette valeur (testé : ~30%, encore nettement RATÉ), tout en étant moins dur sur
// une main qui n'est pas millimétrée sur une ligne droite rapide
