...
- **Étape 3** : écran — coût en mana, sorts grisés ; PETITE LIGNE D'ÉTATS à côté de chaque barre de PV (à DROITE pour nos créatures, à GAUCHE pour les adversaires) avec l'icône de chaque bonus/malus (`iconesEtats`, emojis en attendant les logos de l'auteur).
