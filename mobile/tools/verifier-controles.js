...
const SABOTAGES = [
  ...
  ['auditElixir', F.aventure, "le sous-composant qui lance les combats ne reçoit plus l'Élixir (plantage à l'exécution)",
    remplace('onOpenCreature, elixirCombats = 0, onElixirUsed, onBuyElixir }) {', 'onOpenCreature, onBuyElixir }) {')],
  ...
  ['auditDefaite', F.aventure, "l'Élixir de l'écran de défaite débranché du sous-composant (plantage)",
    remplace('onOpenCreature, elixirCombats = 0, onElixirUsed, onBuyElixir }) {', 'onOpenCreature, elixirCombats = 0, onElixirUsed }) {')],
